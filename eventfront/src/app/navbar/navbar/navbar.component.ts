...
export class NavbarComponent implements OnInit {
 ...
 route=inject(Router)
  ...
  constructor() {
    effect(() => {
      this.isLoggedIn=this.adminCount();
    });
  }
